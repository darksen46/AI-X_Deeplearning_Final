...
AI+X: Deep Learning — Group G34, Option A: 

공개 AI 텍스트 데이터셋을 활용한 일반 AI 탐지 모델 구현과 개인 글쓰기 패턴 기반 문체 일관성 검증 실험
...
| ---- | ----------------- | -------------------------------------------------------------- | ------------------------------- |
| 위강현 | 컴퓨터소프트웨어학부 1학년 2026084302   | [kanghyun.wi@hanyang.ac.kr](mailto:kanghyun.we@hanyang.ac.kr) | 데이터셋 수집 및 정리, 조원 글 작성 데이터 관리    |
